...
namespace Utj
{
    ...
    /// </summary>
    public class ScriptDriver : MonoBehaviour
    {
        ...
        /// 
        /// </summary>
        public static ScriptDriver instance
        {
            get;
            private set;
        }
        ...
        public void Play(int index = 0)
        {
            ...
            isPlay = true;
            isError = false;
            m_overrideInputBackup = DummyInput.instance.isOverrideInput;
            DummyInput.instance.isOverrideInput = true;
            PreProcessor();            
        }
        ...
        /// Waitの処理
        /// </summary>
        /// <param name="args">args[0]:wait args[1]:待機時間</param>
        /// <returns></returns>
        bool CommandWait(string[] args)
        {
            waitFrame = args.Length >= 2 ? System.Convert.ToInt32(args[1]) : 0;
            return false;
        }
        ...
        bool CommandTouch(string[] args)
        {
            ...
            if (string.Compare(type, "begin") == 0)
            {
                if (args[3].StartsWith("\""))
                {
                    ...
                    DummyInput.instance.SetTouchBegin(fingerId, name);
                }
                else
                {
                    ...
                    if (args.Length == 5)
                    {
                        DummyInput.instance.SetTouchBegin(fingerId, position);
                    }
            ...
            else if(string.Compare(type,"move") == 0)
            {
                ...
                DummyInput.instance.SetTouchMove(fingerId,position);
                if (args.Length == 5)
                {
                    DummyInput.instance.SetTouchMove(fingerId, position);
                }
            ...
            {
                DummyInput.instance.SetTouchEnded(fingerId);
            }
            return true;
        }
        ...
        {            
            ...
            DummyInput.instance.SetButtonDown(name, isDown);
            return true;
        }
        ...
        bool CommandAxisRaw(string[] args)
        {
            ...
            DummyInput.instance.SetAxisRaw(name, GetFloat(args[2]));
            return true;
        }
        ...
        bool CommandMouseButton(string[] args)
        {
            ...
            {
                DummyInput.instance.SetMouseButtonDown(GetInt(args[2]));
            }
            else
            {
                DummyInput.instance.SetMouseButtonUp(GetInt(args[2]));
            }
            return true;
        }
        ...
        bool CommandMousePosition(string[] args)
        {
            ...
            DummyInput.instance.SetMousePosition(position);
            return true;
        }
        ...
        {            
            ...
            if ((textAssetReader == null) || (textAssetReader.EndOfStream))
            {
                isPlay = false;
                DummyInput.instance.isOverrideInput = m_overrideInputBackup;
                return;
            }
